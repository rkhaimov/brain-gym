...
Дефекта легко пропустить ввиду того что затрагивается больше кол-во компонентов системы (транзитивно, не напрямую). Не
всякий человек (инженер, QA) будет постоянно, точно и беспристрастно перепроверять каждый зависимый сценарий.
...
К сожалению, основным фактором успеха здесь являются опыт и удача. Невозможно с полной увереностью предугадать
направление течения проекта.
...
только удовлетворит новым вводным, но и защитит от подобных поворотов в будущем.
