...
В общем случае, указанные проблемы ведут за собой изменения во всех зависимых от `Button` страницах, что и называется *жесткостью*

*Рис - страницы с кнопкой (измененные)*
...
*Рис - Страницы с `Button` с опциональным свойством (изменен только `Button`)*
...
*Рис - Страницы с `Button` (все изменено)*
