...
import { createUtilsContext } from '../createUtilsContext';
import { Implementation, ImplementationSchema } from '../schemas';
...
function createSystemPrompt() {
  return fs
    ...
    .replace('{UtilsContext}', JSON.stringify(createUtilsContext()));
}
