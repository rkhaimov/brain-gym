...
import { ToolMeta, ToolName } from '../llm/types/tool-types';
import { Tool, ToolContext, ToolFn } from './types';

export function create<TSchema extends z.ZodType, TReturn>(config: {
  name: string;
  description: string;
  schema: TSchema;
